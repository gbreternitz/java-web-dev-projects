...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Oreos",.5, new ArrayList<>(Arrays.asList("dairy")));
        Topping topping2 = new Topping("Sprinkles",.25, new ArrayList<>(Arrays.asList("red #5")));
        Topping topping3 = new Topping("Creme de Chantilly",1.25, new ArrayList<>(Arrays.asList("alcohol")));
